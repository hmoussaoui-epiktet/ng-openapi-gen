...
import { ReferenceObject, SchemaObject, isArraySchemaObject, isReferenceObject } from './openapi-typings';
...
export abstract class GenType {
	...
	constructor(public name: string, typeNameTransform: (typeName: string, options: Options) => string, public options: Options) {
